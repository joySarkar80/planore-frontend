...
export default function EventDetailsPage() {
  ...
  const isPending = pendingRequests.includes(currentUser.id)
      ...
      return (
        <div className="flex flex-col gap-3">
          ...
          <div className="flex gap-3">
            ...
            <Button
              variant="outline"
              className="h-12 w-12 rounded-xl border-slate-200 text-red-500 hover:bg-red-50 p-0"
            >
                ...
                <div className="grid md:grid-cols-2 gap-8 mb-12">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-lg font-bold text-slate-900 truncate max-w-[200px]">
                        {event.venue}
                      </div>
                    </div>
                  </div>
                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="flex gap-2 mb-4">
                      {[1, 2, 3, 4, 5].map((star) => (
                        <Star
                          key={star}
                          className={`h-6 w-6 cursor-pointer ${newReview.rating >= star
                    ...
                    <Button className="bg-indigo-600 text-white font-bold h-11 rounded-xl px-6">
                      Submit Review
                    </Button>
                  </CardContent>
                </Card>
          ...
          <div className="space-y-6">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="min-w-0">
                      <div className="font-black text-slate-900 text-lg truncate">
                        {event.organizer}
                      </div>
            ...
            <Card className="rounded-[2rem] border-none bg-slate-900 text-white overflow-hidden p-8 shadow-xl">
              ...
              <p className="text-sm text-slate-400 leading-relaxed font-medium">
                All events on Evently are protected by our SecurePay system.
                Payments are held in escrow until the event successfully
                completes.
              </p>
            </Card>
          </div>
